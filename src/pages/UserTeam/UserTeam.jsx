...
const UserTeam = ({ user }) => {
  ...
  if (!user) {
    return (
      <h1 className="text-center m-5 p-5 bg-danger text-white">
  ...
  if (!user.team) {
    user.team = [
      ...
      },
      {
        ...
        label: "DEF",
        players: [
          { id: 1, name: "Pique", team: "Barcelona" },
          { id: 2, name: "Kounde", team: "Barcelona" },
          { id: 3, name: "Araujo", team: "Barcelona" },
        ],
      },
      {
        id: 2,
  ...
  const chosenPlayers = user.team.reduce(
